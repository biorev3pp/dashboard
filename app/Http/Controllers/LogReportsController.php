...
class LogReportsController extends Controller
{
    ...
    public function sinkLogEmailSingle(){
        for($i = 1; $i < 100; $i++):
            ...
            $deliveredEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("deliveredAt", "=", $date)->count();
            $openedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("deliveredAt", "=", $date)->count();
            $repliedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("deliveredAt", "=", $date)->count();
            $bouncedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("bouncedAt", "=", $date)->count();
            $unsubscribedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("unsubscribedAt", "=", $date)->count();
            $clickedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("clickedAt", "=", $date)->count();
            
            // $deliveredEmail = OutreachMailings::where("mailingType", "=", "single")->where("state", "=", "delivered")->whereDate("deliveredAt", "=", $date)->count();
            // $openedEmail = OutreachMailings::where("mailingType", "=", "single")->where("state", "=", "opened")->whereDate("deliveredAt", "=", $date)->count();
            // $repliedEmail = OutreachMailings::where("mailingType", "=", "single")->where("state", "=", "replied")->whereDate("deliveredAt", "=", $date)->count();
            // $bouncedEmail = OutreachMailings::where("mailingType", "=", "single")->where("state", "=", "bounced")->whereDate("bouncedAt", "=", $date)->count();
            // $unsubscribedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("unsubscribedAt", "=", $date)->count();
            // $clickedEmail = OutreachMailings::where("mailingType", "=", "single")->whereDate("clickedAt", "=", $date)->count();
    ...
    public function sinkLogEmailSequence(){
        for($i = 1; $i < 100; $i++):
            $date = date("Y-m-d", strtotime("now")-$i*24*3600);
            $deliveredEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("deliveredAt", "=", $date)->count();
            $openedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("deliveredAt", "=", $date)->count();
            $repliedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("deliveredAt", "=", $date)->count();
            $bouncedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("bouncedAt", "=", $date)->count();
            $unsubscribedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("unsubscribedAt", "=", $date)->count();
            $clickedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("clickedAt", "=", $date)->count();
            
            // $deliveredEmail = OutreachMailings::where("mailingType", "=", "sequence")->where("state", "=", "delivered")->whereDate("deliveredAt", "=", $date)->count();
            // $openedEmail = OutreachMailings::where("mailingType", "=", "sequence")->where("state", "=", "opened")->whereDate("deliveredAt", "=", $date)->count();
            // $repliedEmail = OutreachMailings::where("mailingType", "=", "sequence")->where("state", "=", "replied")->whereDate("deliveredAt", "=", $date)->count();
            // $bouncedEmail = OutreachMailings::where("mailingType", "=", "sequence")->where("state", "=", "bounced")->whereDate("bouncedAt", "=", $date)->count();
            // $unsubscribedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("unsubscribedAt", "=", $date)->count();
            // $clickedEmail = OutreachMailings::where("mailingType", "=", "sequence")->whereDate("clickedAt", "=", $date)->count();
    ...
    public function sinkLogEmailAll(){
        for($i = 1; $i < 100; $i++):
            $date = date("Y-m-d", strtotime("now")-$i*24*3600);
            $deliveredEmail = OutreachMailings::whereDate("deliveredAt", "=", $date)->count();
            $openedEmail = OutreachMailings::whereDate("deliveredAt", "=", $date)->count();
            $repliedEmail = OutreachMailings::whereDate("deliveredAt", "=", $date)->count();
            $bouncedEmail = OutreachMailings::whereDate("bouncedAt", "=", $date)->count();
            $unsubscribedEmail = OutreachMailings::whereDate("unsubscribedAt", "=", $date)->count();
            $clickedEmail = OutreachMailings::whereDate("clickedAt", "=", $date)->count();
            
            // $deliveredEmail = OutreachMailings::where("state", "=", "delivered")->whereDate("deliveredAt", "=", $date)->count();
            // $openedEmail = OutreachMailings::where("state", "=", "opened")->whereDate("deliveredAt", "=", $date)->count();
            // $repliedEmail = OutreachMailings::where("state", "=", "replied")->whereDate("deliveredAt", "=", $date)->count();
            // $bouncedEmail = OutreachMailings::where("state", "=", "bounced")->whereDate("bouncedAt", "=", $date)->count();
            // $unsubscribedEmail = OutreachMailings::whereDate("unsubscribedAt", "=", $date)->count();
            // $clickedEmail = OutreachMailings::whereDate("clickedAt", "=", $date)->count();
