                ...
                <div class="row mx-0 mb-1">
                    <div class="col-md-4 col-12 pl-0">
                        <div class="filter-btns-holder">
                            <span v-if="form.agentName" class="filter-btns mb-0">
                                <span  class="text-dark mx-1 pointer-hand wf-180"> 
                                    Agent : {{ form.agentName }}
                                </span>
                            </span>
                            <span v-if="form.type" class="filter-btns mb-0">
                                <span  class="text-dark mx-1 pointer-hand wf-180"> 
                                    Emails Type : {{ form.type }}
                                </span>
                            </span>
                            <span class="filter-btns mb-0">
                                <span  class="text-dark mx-1 pointer-hand wf-180" v-if="form.dateRange.hasOwnProperty('startDate')"> 
                                    Date : {{ form.dateRange.startDate.substring(0,10) }} - {{ form.dateRange.endDate.substring(0,10) }}
                                </span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12 pr-0 text-right form-inline d-block">
                        <span class="mr-2">
                            ...
                            <select class="form-control" v-model="form.sortType" @change="getDatasetsCall(1)">
                                <option value="bouncedAt">Bounced At</option>
                                <option value="clickedAt">Clicked At</option>
                                <option value="deliveredAt">DeliveredAt</option>
                                <option value="openedAt">Opened At</option>
                                <option value="repliedAt">Replied At</option>
                            </select>
                        </span>
                        <span class="mr-2">
...
export default {
    components:{CallLog, EmailLog, DateRangePicker, ToggleButton, ExportWizard, RadialProgressBar},
    data() {
        return {
            callDiff : 100,
            showProgress : false,
    ...
    methods: {
        ...
        selectAllRecords()
        {
            ...
            this.$Progress.start();  
            this.form.page = 1
            this.form.post('/api/get-emails-all').then((response) => {
